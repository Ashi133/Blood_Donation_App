...
public class RecipientRegistrationActivity extends AppCompatActivity {
    ...
    private EditText registerFullName,registerPhoneNumber, registerEmail,registerPassword;
                            ...
                            if (!task.isSuccessful()){
                                ...
                                userDatabaseRef.updateChildren(userInfo).addOnCompleteListener(new OnCompleteListener() {
                                    ...
                                    public void onComplete(@NonNull Task task) {
                                        ...
                                        if (task.isSuccessful()){
                                            String error =task.getException().toString();
                                            Toast.makeText(RecipientRegistrationActivity.this, "data set successfully"+ error, Toast.LENGTH_SHORT).show();
                                        }
                                        else {
